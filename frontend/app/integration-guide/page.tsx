...
function CodeBlock({
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 relative">
      <code className="text-sm text-gray-800 font-mono whitespace-pre-wrap break-all block pr-10">
        {code}
      </code>
      <Button
...
export default function IntegrationGuidePage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      {/* Features */}
      <Card className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Features included</h2>
        <div className="grid md:grid-cols-3 gap-6">
          {FEATURES_LIST.map((group) => (
            <div key={group.title}>
              <h3 className="font-semibold text-indigo-600 mb-2">{group.title}</h3>
      ...
      <Card className="mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">1. Collect testimonials</h2>
        </div>
      ...
      <Card className="mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">2. Display — Wall of Love (declarative)</h2>
        </div>
        <p className="text-gray-600 mb-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-4 text-sm">
          <div>
            <p className="font-medium text-gray-900 mb-1">Layouts</p>
            <p className="text-gray-600">{LAYOUTS.join(', ')}</p>
          </div>
          <div>
            <p className="font-medium text-gray-900 mb-1">Themes</p>
            <p className="text-gray-600">{THEMES.join(', ')}</p>
          </div>
        </div>
      </Card>
      ...
      {/* Iframe wall */}
      <Card className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Display — Iframe (WordPress, Webflow)</h2>
        <p className="text-gray-600 mb-4">
      ...
      {/* React */}
      <Card className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. React / Next.js</h2>
        <p className="text-gray-600 mb-4">
        ...
        <CodeBlock
          ...
          onCopy={copyToClipboard}
        />
        <Link href="/integrations/nextjs" className="text-indigo-600 text-sm hover:underline inline-flex items-center mt-2">
      ...
      <Card className="mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">Dashboard configuration</h2>
        </div>
        <p className="text-gray-600 mb-4">Customize in the app — not in embed code:</p>
      ...
      <Card className="mb-6">
        ...
        <div className="text-sm font-mono text-gray-800 space-y-2 bg-gray-50 p-4 rounded-lg">
      ...
      <Card className="mb-6">
        ...
        <div className="space-y-6 text-sm">
          <div>
            <h3 className="font-medium text-gray-900 mb-2">CSP blocked?</h3>
            <CodeBlock code={cspMetaTag} id="csp" copiedSection={copiedSection} onCopy={copyToClipboard} />
          </div>
          <div>
            <h3 className="font-medium text-gray-900 mb-2">Testimonials not showing?</h3>
          ...
          <div>
            <h3 className="font-medium text-gray-900 mb-2">Iframe height wrong?</h3>
            <p className="text-gray-700">Use iframe-resizer snippet from Embed Studio — avoid fixed 800px height.</p>
          </div>
        </div>
      </Card>
    </div>
